    ...
    return (
        ...
        <div className="container mx-auto mb-20 min-h-screen">
            ...
            {cart.length === 0 ? (
                ...
                <>
                    <h1 className="leading-relaxed font-primary font-extrabold text-4xl text-center text-palette-primary mt-4 py-2 sm:py-4 " style={{color:'#EFE6E6'}}>
                        سبد خرید شما
                    </h1>

                    <div className="min-h-80 max-w-2xl my-4 sm:my-8 mx-auto w-full" style={{color:'#EFE6E6'}}>
                            ...
                            <tbody className="divide-y divide-palette-lighter">
                                {cart.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td className="font-primary font-medium px-4 sm:px-6 py-4">
                                            ...
                                            >
                                            <AiOutlineClose size={30} color='#FF0E0E'/>
                                            </button>
                                        </td>
                                    </tr>
                                ))}
                                {cartTotalAmount === 0 ? null : (
                                    <tr className="text-center">
                                        <td></td>
                                        <td className="font-primary text-base text-gray-600 font-semibold uppercase px-4 sm:px-6 py-4" style={{color:'#EFE6E6'}}>
                                            قیمت کل :
                                        </td>
      ...
      justify-center items-center focus:ring-1 focus:ring-palette-light focus:outline-none w-full hover:bg-palette-lighter rounded-sm" style={{color:'#EFE6E6'}}
                        >
